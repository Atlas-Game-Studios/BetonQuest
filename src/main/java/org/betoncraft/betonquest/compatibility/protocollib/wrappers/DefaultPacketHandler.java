package org.betoncraft.betonquest.compatibility.protocollib.wrappers;
...
public final class DefaultPacketHandler implements PacketHandler {
     ...
     */
    DefaultPacketHandler(final PacketType type) {
     ...
     * @param type   - the packet type.
     */
    DefaultPacketHandler(final PacketContainer handle, final PacketType type) {
        this(handle);
