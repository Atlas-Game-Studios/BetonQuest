...
import org.betoncraft.betonquest.*;
...
import org.betoncraft.betonquest.events.GiveEvent;
...
import org.betoncraft.betonquest.utils.location.VectorData;
...
public class QuestCommand implements CommandExecutor, SimpleTabCompleter {
    ...
    private void handleRenaming(final CommandSender sender, final String... args) {
        ...
        final Connector.UpdateType updateType;
        switch (type) {
            case "tags":
            case "tag":
            case "t":
        ...
        BetonQuest.getInstance().getSaver().add(new Saver.Record(updateType, rename, name));
    ...
    private void handleDeleting(final CommandSender sender, final String... args) {
        ...
        BetonQuest.getInstance().getSaver().add(new Saver.Record(updateType, name));
