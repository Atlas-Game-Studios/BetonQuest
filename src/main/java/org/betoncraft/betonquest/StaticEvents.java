...
public class StaticEvents {
        ...
        for (final ConfigPackage pack : Config.getPackages().values()) {
            ...
            for (final String key : config.getKeys(false)) {
                ...
                try {
                    ...
                    final org.betoncraft.betonquest.id.EventID[] eventIDS = new org.betoncraft.betonquest.id.EventID[events.length];
                    for (int i = 0; i < events.length; i++) {
                        eventIDS[i] = new org.betoncraft.betonquest.id.EventID(pack, events[i]);
                    }
    ...
    private static class EventTimer extends TimerTask {
        ...
        protected final org.betoncraft.betonquest.id.EventID[] event;
         ...
         * @param eventID
         */
        public EventTimer(final long timeStamp, final org.betoncraft.betonquest.id.EventID... eventID) {
            super();
