...
import org.betoncraft.betonquest.id.ID;
import org.betoncraft.betonquest.id.ItemID;
import org.betoncraft.betonquest.id.NoID;
...
public class Instruction {
    ...
    private org.betoncraft.betonquest.id.ID identifier;
    private int nextIndex = 1;
    private int currentIndex = 1;
    private String lastOptional;

    public Instruction(final ConfigPackage pack, final org.betoncraft.betonquest.id.ID identifier, final String instruction) {
        this.pack = pack;
        try {
    ...
    private QuestItem getQuestItem(final String string) throws InstructionParseException {
        ...
        try {
            return new QuestItem(new org.betoncraft.betonquest.id.ItemID(pack, string));
    ...
    public Item[] getItemList(final String string) throws InstructionParseException {
        ...
        for (int i = 0; i < items.length; i++) {
            try {
                final org.betoncraft.betonquest.id.ItemID item;
    ...
    public org.betoncraft.betonquest.id.EventID getEvent() throws InstructionParseException {
        return getEvent(next());
    }

    public org.betoncraft.betonquest.id.EventID getEvent(final String string) throws InstructionParseException {
        if (string == null) {
            return null;
        }
        try {
    ...
    public org.betoncraft.betonquest.id.ConditionID getCondition() throws InstructionParseException {
        return getCondition(next());
    }

    public org.betoncraft.betonquest.id.ConditionID getCondition(final String string) throws InstructionParseException {
        if (string == null) {
            return null;
        }
        try {
    ...
    public org.betoncraft.betonquest.id.ObjectiveID getObjective() throws InstructionParseException {
        return getObjective(next());
    }

    public org.betoncraft.betonquest.id.ObjectiveID getObjective(final String string) throws InstructionParseException {
        if (string == null) {
            return null;
        }
        try {
    ...
    public org.betoncraft.betonquest.id.ItemID getItem() throws InstructionParseException {
        return getItem(next());
    }

    public org.betoncraft.betonquest.id.ItemID getItem(final String string) throws InstructionParseException {
        if (string == null) {
            return null;
        }
        try {
            return new org.betoncraft.betonquest.id.ItemID(pack, string);
        } catch (ObjectNotFoundException e) {
    ...
    public static class Item {
        ...
        private final org.betoncraft.betonquest.id.ItemID itemID;
        private final QuestItem questItem;
        private final VariableNumber amount;

        public Item(final org.betoncraft.betonquest.id.ItemID itemID, final VariableNumber amount) throws InstructionParseException {
            this.itemID = itemID;
