...
import org.betoncraft.betonquest.api.*;
import org.betoncraft.betonquest.commands.*;
import org.betoncraft.betonquest.compatibility.Compatibility;
import org.betoncraft.betonquest.conditions.*;
import org.betoncraft.betonquest.config.Config;
import org.betoncraft.betonquest.config.ConfigPackage;
import org.betoncraft.betonquest.config.ConfigUpdater;
import org.betoncraft.betonquest.conversation.*;
import org.betoncraft.betonquest.database.*;
import org.betoncraft.betonquest.events.*;
...
import org.betoncraft.betonquest.id.VariableID;
import org.betoncraft.betonquest.item.QuestItemHandler;
import org.betoncraft.betonquest.mechanics.PlayerHider;
import org.betoncraft.betonquest.notify.*;
import org.betoncraft.betonquest.objectives.*;
import org.betoncraft.betonquest.utils.*;
import org.betoncraft.betonquest.variables.*;
...
public class BetonQuest extends JavaPlugin {
    ...
    private static final Map<org.betoncraft.betonquest.id.ConditionID, Condition> CONDITIONS = new HashMap<>();
    private static final Map<org.betoncraft.betonquest.id.EventID, QuestEvent> EVENTS = new HashMap<>();
    private static final Map<org.betoncraft.betonquest.id.ObjectiveID, Objective> OBJECTIVES = new HashMap<>();
    private static final Map<String, ConversationData> CONVERSATIONS = new HashMap<>();
    private static final Map<org.betoncraft.betonquest.id.VariableID, Variable> VARIABLES = new HashMap<>();
    ...
    public static boolean conditions(final String playerID, final Collection<org.betoncraft.betonquest.id.ConditionID> conditionIDs) {
        final org.betoncraft.betonquest.id.ConditionID[] ids = new org.betoncraft.betonquest.id.ConditionID[conditionIDs.size()];
        int index = 0;
        for (final org.betoncraft.betonquest.id.ConditionID id : conditionIDs) {
            ids[index++] = id;
        }
        return conditions(playerID, ids);
    }

    public static boolean conditions(final String playerID, final org.betoncraft.betonquest.id.ConditionID... conditionIDs) {
    ...
    public static boolean condition(final String playerID, final org.betoncraft.betonquest.id.ConditionID conditionID) {
        // null check
        if (conditionID == null) {
        ...
        for (final Entry<org.betoncraft.betonquest.id.ConditionID, Condition> e : CONDITIONS.entrySet()) {
     ...
     */
    public static void event(final String playerID, final org.betoncraft.betonquest.id.EventID eventID) {
        // null check
        if (eventID == null) {
        ...
        for (final Entry<org.betoncraft.betonquest.id.EventID, QuestEvent> e : EVENTS.entrySet()) {
    ...
    public static void newObjective(final String playerID, final org.betoncraft.betonquest.id.ObjectiveID objectiveID) {
        // null check
        ...
        for (final Entry<org.betoncraft.betonquest.id.ObjectiveID, Objective> e : OBJECTIVES.entrySet()) {
     ...
     */
    public static void resumeObjective(final String playerID, final org.betoncraft.betonquest.id.ObjectiveID objectiveID, final String instruction) {
        // null check
    ...
    public static Variable createVariable(final ConfigPackage pack, final String instruction)
        ...
        final org.betoncraft.betonquest.id.VariableID variableID;
        try {
            variableID = new org.betoncraft.betonquest.id.VariableID(pack, instruction);
    ...
    public void loadData() {
        ...
        for (final ConfigPackage pack : Config.getPackages().values()) {
            ...
            for (final String key : eConfig.getKeys(false)) {
                ...
                final org.betoncraft.betonquest.id.EventID identifier;
                try {
            ...
            for (final String key : cConfig.getKeys(false)) {
                ...
                final org.betoncraft.betonquest.id.ConditionID identifier;
                try {
            ...
            for (final String key : oConfig.getKeys(false)) {
                ...
                final org.betoncraft.betonquest.id.ObjectiveID identifier;
                try {
                    identifier = new org.betoncraft.betonquest.id.ObjectiveID(pack, key);
                } catch (final ObjectNotFoundException e) {
                    LogUtils.getLogger().log(Level.WARNING,
     ...
     */
    public Objective getObjective(final org.betoncraft.betonquest.id.ObjectiveID objectiveID) {
        for (final Entry<org.betoncraft.betonquest.id.ObjectiveID, Objective> e : OBJECTIVES.entrySet()) {
            if (e.getKey().equals(objectiveID)) {
                return e.getValue();
            }
     ...
     */
    public void renameObjective(final org.betoncraft.betonquest.id.ObjectiveID name, final ObjectiveID rename) {
