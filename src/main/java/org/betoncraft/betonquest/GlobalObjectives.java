...
public class GlobalObjectives {
    ...
    private final Set<org.betoncraft.betonquest.id.ObjectiveID> globalObjectiveIds;
     ...
     */
    public static void add(final org.betoncraft.betonquest.id.ObjectiveID objectiveID) {
    ...
    public static void startAll(final String playerID) {
        ...
        for (final org.betoncraft.betonquest.id.ObjectiveID id : instance.globalObjectiveIds) {
     ...
     */
    public static String getTag(final org.betoncraft.betonquest.id.ObjectiveID objectiveID) {
